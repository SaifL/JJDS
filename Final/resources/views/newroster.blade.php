...
<html>
    ...
    <form action="">
        ...
        <select class="slightleft" type="text" name="Supervisor" placeholder="SuperVisor" ></select><br><br>
        <label class="where" for="Doctor">Docotor</label>
        <select class="slightleft" type="text" name="Doctor" placeholder="Doctor" ></select><br><br>
        <label class="where" for="Caregiver1">Caregiver1</label>
        <select class="slightleft" type="text" name="Caregiver1" placeholder="Caregiver1" ></select><br><br>
        <label class="where" for="Caregiver1">Caregiver2</label>
        <select class="slightleft" type="text" name="Caregiver2" placeholder="Caregiver2" ></select><br><br>
